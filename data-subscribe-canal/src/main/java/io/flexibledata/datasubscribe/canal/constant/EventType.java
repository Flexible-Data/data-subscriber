 ...
 * </p>
 */
package io.flexibledata.datasubscribe.canal.constant;
...
public enum EventType {
	...
	public static EventType valueFrom(final String eventTypeName) {
		Optional<EventType> eventTypeOptional = Iterators.tryFind(Arrays.asList(EventType.values()).iterator(),
				new Predicate<EventType>() {
